-- this is the first git commit i havew done without main but in master and have added the files which i have practised on my own and the question are below
